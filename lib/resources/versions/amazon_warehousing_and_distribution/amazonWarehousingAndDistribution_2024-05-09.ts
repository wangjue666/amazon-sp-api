...
export default {
  '2024-05-09': {
    createInbound: (req_params: ReqParams): ReqParams => {
    ...
    getInbound: (req_params: ReqParams): ReqParams => {
    ...
    updateInbound: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          orderId: {
            type: 'string'
    ...
    cancelInbound: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          orderId: {
            type: 'string'
    ...
    confirmInbound: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          orderId: {
            type: 'string'
    ...
    getInboundShipment: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          shipmentId: {
            type: 'string'
    ...
    getInboundShipmentLabels: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          shipmentId: {
            type: 'string'
    ...
    updateInboundShipmentTransportDetails: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          shipmentId: {
            type: 'string'
    ...
    checkInboundEligibility: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    listInboundShipments: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    listInventory: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
