...
export default {
  v1: {
    ...
    getInventorySummaries: (req_params: ReqParams): ReqParams => {
    ...
    createInventoryItem: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    deleteInventoryItem: (req_params: ReqParams): ReqParams => {
    ...
    addInventory: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
