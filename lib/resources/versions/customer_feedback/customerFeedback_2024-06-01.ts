...
export default {
  '2024-06-01': {
    getItemReviewTopics: (req_params: ReqParams): ReqParams => {
    ...
    getItemBrowseNode: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          asin: {
            type: 'string'
    ...
    getBrowseNodeReviewTopics: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          browseNodeId: {
            type: 'string'
    ...
    getItemReviewTrends: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          asin: {
            type: 'string'
    ...
    getBrowseNodeReviewTrends: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          browseNodeId: {
            type: 'string'
    ...
    getBrowseNodeReturnTopics: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          browseNodeId: {
            type: 'string'
    ...
    getBrowseNodeReturnTrends: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          browseNodeId: {
            type: 'string'
