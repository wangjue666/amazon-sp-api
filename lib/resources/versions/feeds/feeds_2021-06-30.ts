...
export default {
  '2021-06-30': {
    getFeeds: (req_params: ReqParams): ReqParams => {
    ...
    createFeed: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
        api_path: '/feeds/2021-06-30/feeds',
        restore_rate: 120
    ...
    getFeed: (req_params: ReqParams): ReqParams => {
    ...
    cancelFeed: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          feedId: {
            type: 'string'
    ...
    createFeedDocument: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    getFeedDocument: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          feedDocumentId: {
            type: 'string'
