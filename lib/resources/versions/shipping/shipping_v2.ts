...
export default {
  v2: {
    getRates: (req_params: ReqParams): ReqParams => {
    ...
    purchaseShipment: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    oneClickShipment: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    getTracking: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    getShipmentDocuments: (req_params: ReqParams): ReqParams => {
    ...
    getAccessPoints: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    submitNdrFeedback: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    getAdditionalInputs: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    directPurchaseShipment: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
