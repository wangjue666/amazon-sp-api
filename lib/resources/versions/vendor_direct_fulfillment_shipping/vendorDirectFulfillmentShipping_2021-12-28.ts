...
export default {
  '2021-12-28': {
    getShippingLabels: (req_params: ReqParams): ReqParams => {
    ...
    submitShippingLabelRequest: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
        api_path: '/vendor/directFulfillment/shipping/2021-12-28/shippingLabels',
        restore_rate: 0.1
    ...
    getShippingLabel: (req_params: ReqParams): ReqParams => {
    ...
    createShippingLabels: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          purchaseOrderNumber: {
            type: 'string'
    ...
    submitShipmentStatusUpdates: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    getCustomerInvoices: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    getCustomerInvoice: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          purchaseOrderNumber: {
            type: 'string'
    ...
    getPackingSlips: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    getPackingSlip: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          purchaseOrderNumber: {
            type: 'string'
    ...
    createContainerLabel: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
