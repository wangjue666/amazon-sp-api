...
export default {
  v1: {
    getSubscription: (req_params: ReqParams): ReqParams => {
    ...
    createSubscription: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          notificationType: {
            type: 'enum',
    ...
    getSubscriptionById: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          subscriptionId: {
            type: 'string'
    ...
    deleteSubscriptionById: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          subscriptionId: {
            type: 'string'
    ...
    getDestinations: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    createDestination: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
        api_path: '/notifications/v1/destinations',
        restore_rate: 1,
    ...
    getDestination: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          destinationId: {
            type: 'string'
    ...
    deleteDestination: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          destinationId: {
            type: 'string'
