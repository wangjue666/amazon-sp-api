...
export default {
  '2024-03-01': {
    listAccounts: (req_params: ReqParams): ReqParams => {
    ...
    listAccountBalances: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          accountId: {
            type: 'string'
    ...
    getTransferPreview: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    listAccountTransactions: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    createTransaction: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
        api_path: '/finances/transfers/wallet/2024-03-01/transactions',
        restore_rate: 1
    ...
    getTransaction: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          transactionId: {
            type: 'string'
    ...
    listTransferSchedules: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    createTransferSchedule: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
        api_path: '/finances/transfers/wallet/2024-03-01/transferSchedules',
        restore_rate: 2
    ...
    updateTransferSchedule: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'PUT',
        api_path: '/finances/transfers/wallet/2024-03-01/transferSchedules',
        restore_rate: 2
    ...
    getTransferSchedule: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          transferScheduleId: {
            type: 'string'
    ...
    deleteScheduleTransaction: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          transferScheduleId: {
            type: 'string'
