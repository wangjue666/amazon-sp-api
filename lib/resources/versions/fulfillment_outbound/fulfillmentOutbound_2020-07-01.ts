...
export default {
  '2020-07-01': {
    getFulfillmentPreview: (req_params: ReqParams): ReqParams => {
    ...
    deliveryOffers: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    listAllFulfillmentOrders: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    createFulfillmentOrder: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
        api_path: '/fba/outbound/2020-07-01/fulfillmentOrders',
        restore_rate: 0.5
    ...
    getPackageTrackingDetails: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    listReturnReasonCodes: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    createFulfillmentReturn: (req_params: ReqParams): ReqParams => {
    ...
    getFulfillmentOrder: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          sellerFulfillmentOrderId: {
            type: 'string'
    ...
    updateFulfillmentOrder: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          sellerFulfillmentOrderId: {
            type: 'string'
    ...
    cancelFulfillmentOrder: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          sellerFulfillmentOrderId: {
            type: 'string'
    ...
    submitFulfillmentOrderStatusUpdate: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          sellerFulfillmentOrderId: {
            type: 'string'
    ...
    getFeatures: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    getFeatureInventory: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          featureName: {
            type: 'string'
    ...
    getFeatureSKU: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          featureName: {
            type: 'string'
