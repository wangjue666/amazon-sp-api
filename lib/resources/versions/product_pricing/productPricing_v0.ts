...
export default {
  v0: {
    getPricing: (req_params: ReqParams): ReqParams => {
    ...
    getCompetitivePricing: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'GET',
    ...
    getListingOffers: (req_params: ReqParams): ReqParams => {
    ...
    getItemOffers: (req_params: ReqParams): ReqParams => {
      req_params = checkAndEncodeParams(req_params, {
        path: {
          Asin: {
            type: 'string'
    ...
    getItemOffersBatch: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
    ...
    getListingOffersBatch: (req_params: ReqParams): ReqParams => {
      return Object.assign(req_params, {
        method: 'POST',
